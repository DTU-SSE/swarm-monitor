error id: file://<WORKSPACE>/join-actors/core/src/main/scala/examples/FactorySimpleSocketTypes.scala:`<none>`.
...
enum EventTypes:
  case Pos(position: String, part: String)
  case PartOK(part: String)
  ca@@se PartReq(id: String, lbj: String)
  case ClosingTime(time: String)
