error id: file://<WORKSPACE>/join-actors/core/src/main/scala/examples/WarehouseMonitor.scala:java/net/DatagramPacket#
file://<WORKSPACE>/join-actors/core/src/main/scala/examples/WarehouseMonitor.scala
empty definition using pc, found symbol in pc: java/net/DatagramPacket#
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -actor/DatagramPacket#
	 -actor/Result.DatagramPacket#
	 -java/net/DatagramPacket#
	 -DatagramPacket#
	 -scala/Predef.DatagramPacket#
offset: 4845
...
def receiveLoop(socket: DatagramSocket, monitorFut: Future[Unit], monitorRef: ActorRef[Event]): Unit = {
    ...
    val packet = new @@DatagramPacket(new Array, 4096)
    ...
    val parsedMessage = Msg.parseFrom(message.getBytes())//(inputStream)
    ...
    //monitorRef ! parsedMessage.msgType
