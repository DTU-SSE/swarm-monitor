...
1. Install `smcli`.
2. Generate Protocol Buffers message types corresponding to the events of an example [Actyx](https://www.npmjs.com/package/@actyx/machine-runner) swarm modelling an automated factory.
3. Generate a *forwarder* acting as a bridge between the swarm and monitoring process consuming events from the swarm.
4. Implement a Scala *monitor* based on the [join-actors](https://github.com/a-y-man/join-actors) library.
...
To generate Protocol Buffers message types for the example swarm please move to the directory please run:
