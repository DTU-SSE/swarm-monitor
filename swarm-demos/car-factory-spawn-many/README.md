...
To check that N machines was in fact started run ax run 2> err and start the machines. Then, once the machines have finished, run `grep "Successfully authenticated and authorized com.example.car-factory for trial usage" err | wc -l`.
