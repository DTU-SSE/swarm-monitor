...
START_R="echo 'Starting factory-robot of the Warehouse protocol.'; echo 'Press Ctrl + C to exit.'; npm run start-factory-robot;exec bash"
...
START_FORWARDER="echo 'Starting forwarder'; npm run start-forwarder-alt;exec bash"
...
tmux new-window -n demo-window "$START_FORWARDER"
