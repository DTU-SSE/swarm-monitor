...
import { Events, manifest, Composition, printState, warehouse_protocol, subs_warehouse, getRandomInt, warehouse_factory_protocol, subs_composition } from './protocol'
