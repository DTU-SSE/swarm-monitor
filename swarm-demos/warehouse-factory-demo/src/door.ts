...
import { Events, manifest, Composition, warehouse_protocol, subs_warehouse, printState, getRandomInt, warehouse_factory_protocol, subs_composition } from './protocol'
